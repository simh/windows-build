...
:       specific exceptions handled here and everything else is
:       currently compatible with Visual Studio 2017 libraries
:
set _Path=%~dp0
...
if exist "%_Path%..\lib-VC2017\Debug"   xcopy /S /I "%_Path%..\lib-VC2017\Debug\*"   "%_Path%..\Debug\"       > NUL 2>&1
xcopy /S /Y /I "%_Path%..\lib-VC2017\Debug\*"   "%_Path%..\Debug\"       > NUL 2>&1
...
if exist "%_Path%..\lib-VC2017\Release"   xcopy /S /I "%_Path%..\lib-VC2017\Release\*"   "%_Path%..\Release\" > NUL 2>&1
xcopy /S /Y /I "%_Path%..\lib-VC2017\Release\*"   "%_Path%..\Release\"       > NUL 2>&1
