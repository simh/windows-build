@echo off
: This procedure installs tbe required object libraries to build using 
: Visual Studio 2022
...
xcopy /S /Y /I "%_VerPath%Debug\*"   "%_Path%..\Debug\"       > NUL 2>&1
...
xcopy /S /Y /I "%_VerPath%Release\*" "%_Path%..\Release\"     > NUL 2>&1
if exist "%_VerPath%VisualCVersionSupport.txt" copy /y "%_VerPath%VisualCVersionSupport.txt" "%_Path%..\"        > NUL 2>&1
